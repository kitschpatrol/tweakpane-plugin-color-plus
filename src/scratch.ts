...
import type {RequireExactlyOne, RequireOneOrNone, Simplify} from 'type-fest';
import {RequireAll} from 'type-fest/source/require-all-or-none';

// Detect....
// Alpha = 'auto' | 'enabled' | 'disabled';
// Mode = 'float' | 'int';
// Initial format...
// View format..
// Output format..
// Allow reformat to view format...
...
// console.log(culori.colorsNamed);

/* RGB formats */
console.log(culori.parse('rgb(255 0 0)')); /* Modern space-separated */
console.log(culori.parse('rgb(255, 0, 0)')); /* Legacy comma-separated */
console.log(culori.parse('rgb(255 0 0 / 0.5)')); /* With alpha */
console.log(culori.parse('rgb(100% 0% 0%)')); /* Using percentages */
console.log(culori.parse('rgba(255, 0, 0, 128)')); /* Legacy format */
console.log(culori.parse('rgba(255 0 0 / 1)')); /* Modern format */
console.log(culori.parse('rgba(100% 0% 0% / 50%)')); /* Using percentages */
console.log(culori.parse('hsl(0 100% 50%)')); /* Modern format */
console.log(culori.parse('hsl(0, 100%, 50%)')); /* Legacy format */
console.log(culori.parse('hsl(45deg 100% 50% / 0.5)')); /* With alpha */
console.log(culori.parse('hsla(0, 100%, 50%, 1)')); /* Legacy format */
console.log(culori.parse('hsla(45deg 100% 50% / 1)')); /* Modern format */
console.log(culori.parse('hsla(0 100% 50% / 50%)')); /* With percentage alpha */
console.log(culori.parse('hwb(100deg 20% 0%)')); /* Base format */
console.log(culori.parse('hwb(50deg 0% 20% / 0.5)')); /* With alpha */
console.log(culori.parse('lab(50% 100% -25.49%)')); /* Base format */
console.log(culori.parse('lab(50% 100% -25.49% / 0.5)')); /* With alpha */
console.log(culori.parse('lch(50% 50 0)')); /* Base format */
console.log(culori.parse('lch(50% 50 0 / 0.5)')); /* With alpha */
console.log(culori.parse('oklab(59% 0.1 0.1)')); /* Base format */
console.log(culori.parse('oklab(59% 0.1 0.1 / 0.5)')); /* With alpha */
console.log(culori.parse('oklch(60% 0.15 0)')); /* Base format */
console.log(culori.parse('oklch(60% 0.15 0 / 0.5)')); /* With alpha */
...
const colorObjectFormats: ColorFormat[] = [
...
const cc = objectToColor({h: 25, s: 50, v: 100, a: 25});
console.log(`cc: ${JSON.stringify(cc, undefined, 2)}`);

// console.log(colorToObject(cc, ['r', 'g', 'b', 'a']));
